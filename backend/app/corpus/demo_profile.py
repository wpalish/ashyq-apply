...
DEMO_PROFILE = ApplicantProfileIn(
    ...
    academics=AcademicRecord(
        ...
        ielts=IeltsScore(
            ...
            test_type="academic", dates=TestDate(taken_on="2026-04-18"),
        ),
        ...
        planned_retakes=["SAT on 2026-10-03 targeting 1500", "IELTS writing retake if a 6.5 band is needed"],
    ),
    activities=[
        Activity(
            name="Regional Informatics Olympiad team", category="academic", role="team captain",
        ...
        Activity(
            name="Volunteer coding club at School 42, Astana", category="community",
            role="founder and instructor", duration_months=18, hours_per_week=4, weeks_per_year=40,
        ...
        Activity(
            name="Part-time junior web developer", category="work", role="contractor",
            duration_months=8, hours_per_week=10, weeks_per_year=44,
            responsibility_level="contributor",
            measurable_outcome="Shipped two client sites; maintained them for six months.",
        ),
    ],
    achievements=[
        Achievement(name="National Informatics Olympiad", level="national", year=2026,
                    placement="2nd place (team)",
                    selection_criterion="Top 40 of 900 regional qualifiers."),
        Achievement(name="Republic Mathematics Tournament", level="national", year=2025,
    ...
    preferences=Preferences(
        ...
        values_internships=True, needs_post_study_work=True, needs_work_during_study=True,
        safety_priority="high", housing_guarantee_priority="high",
    ),
    funding=FundingNeeds(
        ...
        must_cover_housing=True, must_cover_meals=True, funding_criticality="decisive",
    ),
)
