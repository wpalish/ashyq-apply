# Human review worksheet: draft3

Underlying dataset: [ground_truth.draft3.json](data/ground_truth.draft3.json). See [projection notes](REVIEW_DRAFT3.md).

AI-prepared only; all ten cases remain draft. 52 known fields reflect the same source facts as draft2, with separate document fields. No new source discoveries or human signatures.

Dataset: `2026-09-20.draft3`; canonical dataset SHA-256 (same serialization as scorer): `70fa6bd487467e676e9a1bd29e17d59bff0851bd85b154bd17c68108bebf77ec`.

Open every official source and verify values, scope and conditions. UNKNOWN is not a negative. Null intake does not establish fall 2027 applicability. Completion alternatives and language exceptions are not unconditional requirements. Record corrections in a newly versioned dataset; never sign on behalf of another person.

## University of Groningen (`groningen`)

- [ ] Sources and exact programme identity reviewed
- [ ] Intake, qualification and population scope reviewed
- [ ] Conditions, UNKNOWN gaps and field applicability reviewed
- [ ] Mapping identities and evidence adjudication reviewed

Reviewer: __________  Date: __________  Decision/corrections: __________

Exact programme URL status: **known**. [programme source](https://www.rug.nl/bachelors/computing-science/?lang=en)
...
**Scope notes:** Programme identity confirmed by AI; human review pending. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://aufnahmeverfahren.univie.ac.at/en/computer-science)
...
**Scope notes:** Admission page reached through official faculty link. Exact intake requires additional evidence. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://informatorects.uw.edu.pl/en/programmes-all/IN/S1-INF/)
...
**Scope notes:** Teaching language is Polish; identity match does not establish language or intake suitability. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://you.ubc.ca/programs/computer-science-vancouver-bsc/)
...
**Scope notes:** Vancouver BSc only. Do not silently equate BA or Okanagan. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://future.utoronto.ca/program/computer-science)
...
**Scope notes:** Official announcement establishes new degree; exact campus programme URL not yet adjudicated. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://admissions.hku.hk/programmes/undergraduate-programmes/computing-and-data-science)
...
**Scope notes:** Combined admission route contains multiple programmes; acceptable route needs human confirmation. PDF brochure is linked but not used as evidence here. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://www.ntu.edu.sg/education/undergraduate-programme/bachelor-of-computing-in-computer-science)
...
**Scope notes:** Exact identity; intake not inferred from evergreen programme page. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
...
Exact programme URL status: **known**. [programme source](https://cs.kaist.ac.kr/content?menu=188)
...
**Scope notes:** Official curriculum page; exact current admission route/degree equivalence needs Korean-speaking human review. Draft2 source audit: AI-prepared only; evergreen policy has no promised 2027 validity. Human review and exact applicant applicability remain pending. Draft3 only projects explicit document fields; no new source facts or human verification.
