# Human review worksheet: draft5

Dataset: `2026-09-21.draft5`; canonical SHA-256: `f4c646947e2fec4852f90003931a0849579bdc0269434b8bd90bc2b075601d17`.

AI-prepared: 0/10 human verified. See [source notes](REVIEW_DRAFT5.md). Exact excerpts/access dates are in [the dataset](data/ground_truth.draft5.json). Null intake is not fall 2027 confirmation; UNKNOWN is not rejection.
