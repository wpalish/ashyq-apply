# Human review worksheet: draft7

Dataset: `2026-09-23.draft7`; canonical SHA-256: `2989ae37b3798078bc0351bd325781cc8a6ee774cc18530c84b4bee858002928`.

AI-prepared: 0/10 human verified — the owner reviewed draft6 and its two corrections are applied here, but no reviewer name or date has been recorded yet, so every case is still `draft`. See [source notes](REVIEW_DRAFT7.md). Exact excerpts/access dates are in [the dataset](data/ground_truth.draft7.json). Null intake is not fall 2027 confirmation; UNKNOWN is not rejection.
...
Programme status: **known**. [source](https://www.aalto.fi/en/study-options/computer-engineering-bachelor-of-science-and-master-of-science-technology)

> **Changed in draft7 by owner review.** Draft6 pointed at the Finnish-language [tietotekniikka page](https://www.aalto.fi/fi/koulutustarjonta/tietotekniikka-tekniikan-kandidaatti-ja-diplomi-insinoori), which is not open to an international applicant in English. The identity is now the English-taught Computer Engineering major. **Open question for you:** Aalto describes that major as combining information technology and electrical engineering — decide whether it counts as the requested *computer science*, or whether this case should go back to `unknown`.

| Field | Draft value | Evidence scope | Source | Conditions |
|---|---|---|---|---|
| `programme.exists` | true | university=Aalto University; programme=Aalto Bachelor's Programme in Science and Technology, Computer Engineering major; degree=bachelor | [source](https://www.aalto.fi/en/study-options/computer-engineering-bachelor-of-science-and-master-of-science-technology) | **Draft7, owner correction.** Existence of an English-taught bachelor route, not field equivalence. Computer Engineering combines information technology and electrical engineering; draft2 refused the same equivalence move for Data Science. No fall 2027 intake confirmation. |
| `programme.teaching_language.primary` | "English" | university=Aalto University; programme=Aalto Bachelor's Programme in Science and Technology, Computer Engineering major; degree=bachelor | [source](https://www.aalto.fi/en/study-options/computer-engineering-bachelor-of-science-and-master-of-science-technology) | **Draft7, corrected from "Finnish".** Aalto states this is its only bachelor route in science and technology taught entirely in English. The Finnish tietotekniikka programme and its Finnish instruction remain true of that separate page. |
...
| Field | Draft value | Evidence scope | Source | Conditions |
|---|---|---|---|---|
| `programme.exists` | true | university=University of Hong Kong; programme=Bachelor of Engineering in Computer Science; degree=bachelor | [source](https://admissions.hku.hk/programmes/undergraduate-programmes/computing-and-data-science) | **Draft7, owner correction.** The exact degree title, not a bare "Computer Science" programme. The same page also lists Artificial Intelligence and Data Science and Applied Artificial Intelligence degrees, which are not this one. |
| `programme.faculty` | "School of Computing and Data Science" | university=University of Hong Kong; programme=Bachelor of Engineering in Computer Science; degree=bachelor | [source](https://admissions.hku.hk/programmes/undergraduate-programmes/computing-and-data-science) | **New in draft7, supplied by owner review.** Do not treat a faculty-level award or requirement as programme-level. |
